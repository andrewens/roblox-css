return function()
    ...
    describe("mount", function()
		...
		local s5 = pcall(RobloxCSS.mount, TestContainer, { Instance.new("Part"), { ThisIsnt = "AFunctionOrInstance" } })
        ...
        it("@post: Styles are applied to all instances in ParentContainer, including ParentContainer, until dismount() is called", function()
		--[[
		...
		local function checkEquality(RootInstance)
			...
			if properties then
				for key, value in properties do
					if RootInstance[key] ~= value then
						error(
